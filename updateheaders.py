#!/usr/bin/env python
# CASTEPKIT: molecular density partition schemes based on HORTON package.
# Copyright (C) 2023-2025 The CASTEPKIT Development Team
#
# This file is part of CASTEPKIT
#
# CASTEPKIT is free software; you can redistribute it and/or
# modify it under the terms of the GNU General Public License
# as published by the Free Software Foundation; either version 3
# of the License, or (at your option) any later version.
#
# CASTEPKIT is distributed in the hope that it will be useful,
...
def main():
    source_dirs = (
        [".", "doc", "data"] + list(iter_subdirs("src/castepkit")) + list(iter_subdirs("tests"))
    )
